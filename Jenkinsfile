    ...
    stage('SonarQube analysis') {
      steps {
        withSonarQubeEnv('sq1') {
          bat 'cd hello-world && C:/tools/sonarqube-10.5.1.90531/sonarqube-10.5.1.90531/bin/windows-x86-64/sonar-scanner -Dsonar.projectKey=squ_90d802fe8575b2d39603660d7d05d9c483009609'
        }
      }
    }
