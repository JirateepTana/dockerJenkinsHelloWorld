...
stage('SonarQube analysis') {
  steps {
    ...
    bat "${scannerHome}\\bin\\sonar-scanner.bat -Dsonar.tests=${projectDir}/tests -Dsonar.lang.patterns.js=**/*.js,**/*.jsx -Dsonar.lang.patterns.ts=**/*.ts,**/*.tsx,**/*.cts,**/*.mts -Dsonar.token=squ_3fb3ed57b73732602c4dc0aaa15e8bdbac498333"
      }
    }
  }
}
