...
stage('SonarQube analysis') {
  steps {
    script {
      ...
      bat "${scannerHome}\\bin\\sonar-scanner.bat -Dsonar.tests=${projectDir}/__tests__ -Dsonar.lang.patterns.js=**/*.js,**/*.jsx -Dsonar.lang.patterns.ts=**/*.ts,**/*.tsx,**/*.cts,**/*.mts -Dsonar.token=squ_bd90399c7c384fe55953f186872af8285fdd776e"
      }
    }
  }
}
